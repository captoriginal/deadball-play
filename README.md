...
Monorepo for playing Deadball with generated MLB rosters. It includes the
Deadball Play terminal application, the shared rules engine and roster
generator, a FastAPI backend, and a Vite + React + Tailwind web interface.
